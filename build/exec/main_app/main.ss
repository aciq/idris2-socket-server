...
(define csegen-16(blodwen-lazy (lambda () (let ((eff-0 (lambda (eta-0) eta-0))) (lambda (arg-0) (eff-0 arg-0))))))
(define csegen-50(blodwen-lazy (lambda () (let ((eff-0 (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (PreludeC-45TypesC-45List-mapAppend '() eta-2 eta-3))))))) (lambda (arg-0) (lambda (arg-1) ((((eff-0 'erased) 'erased) arg-0) arg-1)))))))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define Main-startServer (lambda (arg-0) (PrimIO-io_bind (NetworkC-45Socket-socket (csegen-13) 2 1 0) (lambda (u--osock) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (case (vector-ref u--osock 0) ((0) (PreludeC-45IO-putStrLn (csegen-13) "failed")) (else (let ((e-5 (vector-ref u--osock 1))) (PrimIO-io_bind (NetworkC-45Socket-bind (csegen-13) e-5 (box (vector 2 "0.0.0.0")) arg-0) (lambda (u--res) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) ((csegen-16) "bound to 0.0.0.0")) (let ((sc1 (PreludeC-45EqOrd-u--C-47C-61_Eq_Int u--res (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (lambda () (PreludeC-45IO-putStrLn (csegen-13) (string-append "Failed to bind socket with error: " (PreludeC-45Show-u--show_Show_Int u--res))))) (else (lambda () (PrimIO-io_bind (NetworkC-45Socket-listen (csegen-13) e-5) (lambda (res-0) (let ((sc2 (PreludeC-45EqOrd-u--C-47C-61_Eq_Int res-0 (blodwen-toSignedInt 0 63)))) (cond ((equal? sc2 1) (PreludeC-45IO-putStrLn (csegen-13) (string-append "Failed to listen on socket with error: " (PreludeC-45Show-u--show_Show_Int res-0)))) (else (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (string-append "server running on: " (PreludeC-45Show-u--show_Show_Int arg-0))) (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (SystemC-45FileC-45Process-fflush (csegen-13) (SystemC-45FileC-45Virtual-stdout)) (lambda () (Main-serverLoop 0 (vector 1 e-5))))))))))))))))))))) (lambda () (PreludeC-45IO-putStrLn (csegen-13) "end")))))))
(define Main-serverLoop (lambda (arg-0 arg-1) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "waiting for request") (case (vector-ref arg-1 0) ((0) (lambda () (PreludeC-45IO-putStrLn (csegen-13) "error!!"))) (else (let ((e-5 (vector-ref arg-1 1))) (lambda () (PrimIO-io_bind (Main-resolveSocket arg-0 e-5) (lambda (_-0) (let ((e-3 (cdr _-0))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (NetworkC-45Socket-close (csegen-13) e-3) (lambda () (NetworkC-45Socket-close (csegen-13) e-5)))))))))))))
(define Main-resolveSocket (lambda (arg-0 arg-1) (cond ((equal? arg-0 0) (PrimIO-io_bind (NetworkC-45Socket-accept (csegen-13) arg-1) (lambda (u--osock) (case (vector-ref u--osock 0) ((0) (lambda (eta-0) (cons 3 arg-1))) (else (let ((e-5 (vector-ref u--osock 1))) (let ((e-8 (car e-5))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) "accepted") (lambda () (Main-resolveSocket 1 e-8)))))))))) ((equal? arg-0 1) (PrimIO-io_bind (NetworkC-45Socket-recv (csegen-13) arg-1 (blodwen-toSignedInt 500 63)) (lambda (u--res) (case (vector-ref u--res 0) ((0) (lambda (eta-0) (cons 3 arg-1))) (else (let ((e-5 (vector-ref u--res 1))) (let ((e-8 (car e-5))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (string-append "request: " e-8)) (lambda () (Main-resolveSocket 2 arg-1)))))))))) ((equal? arg-0 2) (PrimIO-io_bind (NetworkC-45Socket-send (csegen-13) arg-1 "HTTP/1.1 200 OK\xd;\xa;Content: text/plain\xd;\xa;\xd;\xa;body") (lambda (u--res) (case (vector-ref u--res 0) ((0) (lambda (eta-0) (cons 3 arg-1))) (else (let ((e-5 (vector-ref u--res 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-13) (string-append ((csegen-16) "sent result:") (PreludeC-45Show-u--show_Show_Int e-5))) (lambda () (Main-resolveSocket 3 arg-1))))))))) (else (lambda (eta-0) (cons 0 arg-1))))))
...
(define DataC-45List1-u--map_Functor_List1 (lambda (arg-2 arg-3) (let ((e-1 (car arg-3))) (let ((e-2 (cdr arg-3))) (cons (arg-2 e-1) (((csegen-50) arg-2) e-2))))))
